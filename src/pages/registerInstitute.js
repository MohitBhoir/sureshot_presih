...
const RegisterInstitute = () => {
  ...
  const {name,email,address,isApproved,contact,password,password2}=formData
       ...
       e.preventDefault()
        if(password!==password2){
          ...
          const res = await fetch("/api/users/", {
              ...
              body: JSON.stringify({name:name,email:email,password:password,type:2,address:address,isApproved:isApproved})
          })
